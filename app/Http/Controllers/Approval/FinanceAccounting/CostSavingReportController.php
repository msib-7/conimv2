...
class CostSavingReportController extends Controller
{
    public function index(Request $request)
    {
                ...
                ->addColumn('action', function ($row) {
                    $btn = '<ul class="list-inline text-center mb-0">
                                                <li class="list-inline-item align-bottom"
                                                    title="View">
                                                    <a href="' . route('v1.financeAccounting.costSavingReport.show', $row->id) . '"
        ...
        return view('v1.csr.financeAccount.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('v1.csr.financeAccount.show', compact('data'));
    }
    ...
    private function berhasil($data, $request)
    {
        try {
            ...
            event(new NotificationEvent(
                ...
                'Cost Saving Report telah disetujui oleh Finance Account ' . auth()->user()->fullname,
                route('v1.csr.index')
            ));
            ...
            return response()->json([
                ...
                'redirect' => route('v1.financeAccounting.costSavingReport.index')
            ]);
        } catch (\Throwable $th) {
            // throw $th;
            DB::rollBack();
    ...
    private function balikan($data, $request)
    {
        ...
        try {
            ...
            event(new NotificationEvent(
                ...
                'Cost Saving Report telah return oleh Finance Accounting ' . auth()->user()->fullname,
                route('v1.csr.index')
            ));
