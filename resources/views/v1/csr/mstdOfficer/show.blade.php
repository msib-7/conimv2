        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('v1.mstdOfficer.csr.store', $data->id) }}" method="POST"
                ...
                <div class="modal-body">
                    <form action="{{ route('v1.mstdOfficer.csr.store', $data->id) }}" method="POST"
                        ...
                        <div class="form-group" id="nomorCC">
                            <label class="form-label" for="nomorSS">Nomor CSR</label>
                            <input type="text" class="form-control" readonly name="nomorCSR" value="CSR/2024/1241"
