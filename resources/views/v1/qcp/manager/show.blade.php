                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label" for="tema">Nama Teams <small
                                                        class="text-danger">*</small></label>
                                                <input type="text"
                                                    class="form-control @error('teams') is-invalid @enderror"
                                                    name="teams" placeholder="E.g QCP" readonly
                                                    value="{{ $data->teams }}">
                                                @error('teams')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#footer-select').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('v1.qcp.edit', $data->id) }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
