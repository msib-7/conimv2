...
@section('button')
    <div class="d-flex">
        <a href="{{ route('v1.qcp.create') }}" class="btn btn-primary btn-nav"><i class="ti ti-plus me-1"></i>Add New</a>
    </div>
@endsection
        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header">
                    ...
                    <p class="mt-0">
                        Manage Your Quality Circle Project
                    </p>
                </div>
        ...
        $(function() {
            ...
            $('body').on('click', '.deletePost', function() {
                ...
                Swal.fire({
                    ...
                    text: "Menghapus data Quality Circle Project akan menghapus seluruh informasi Quality Circle Project",
                    icon: "warning",
