...
@section('title')
    Approval Quality Circle Project
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tema') is-invalid @enderror"
                                    name="tema" placeholder="E.g Tema CSR" readonly value="{{ $data->teams }}">
                                @error('tema')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('v1.financeAccounting.qcp.store', $data->id) }}" method="POST"
                ...
                <div class="modal-body">
                    <form action="{{ route('v1.financeAccounting.qcp.store', $data->id) }}" method="POST"
                        ...
                        <p>Dengan ini saya telah membaca dan menyetujui hasil cost saving yang telah diinputkan pada laporan
                            Quality Circle Project, untuk itu maka saya telah menyetujui hasil tersebut.</p>
