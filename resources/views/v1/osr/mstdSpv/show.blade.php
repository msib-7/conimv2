...
@section('content')
                    ...
                    <form id="detailOsr">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input disabled readonly type="text" class="form-control" disabled readonly
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input disabled readonly type="email"
                                        class="form-control @error('tema') is-invalid @enderror" name="tema"
                                        placeholder="tema" value="{{ $data->tema }}" disabled readonly>
                                    @error('tema')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="lokasi">lokasi Improvement <small
                                            class="text-danger">*</small></label>
                                    <input disabled readonly type="lokasi"
                                        class="form-control @error('lokasi') is-invalid @enderror" name="lokasi"
                                        placeholder="lokasi" value="{{ $data->lokasi }}" disabled readonly>
                                    @error('lokasi')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input disabled readonly type="number"
                                        class="form-control @error('noCC') is-invalid @enderror" name="noCC"
                                        placeholder="noCC" value="{{ $data->nomorCC }}" disabled readonly>
                                    @error('noCC')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('mesin') is-invalid @enderror"
                                        aria-label="Default select example" id="mesin" name="mesin" disabled
                                        readonly>
                                    </select>
                                    @error('mesin')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="specific">specific <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('specific') is-invalid @enderror" id="message"
                                        name="specific" rows="2" placeholder="specific">{!! $data->smart_specific !!}</textarea>
                                    @error('specific')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="measurable">measurable <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('measurable') is-invalid @enderror" id="message"
                                        name="measurable" rows="2" placeholder="Measureable">{!! $data->smart_measurable !!}</textarea>
                                    @error('measurable')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="achievable">achievable <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('achievable') is-invalid @enderror" id="message"
                                        name="achievable" rows="2" placeholder="Achievable">{!! $data->smart_achievable !!}</textarea>
                                    @error('achievable')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Reasonable">Reasonable <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('reasonable') is-invalid @enderror" id="message"
                                        name="reasonable" rows="2" placeholder="Reasonable">{!! $data->smart_reasonable !!}</textarea>
                                    @error('reasonable')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="TimeBased">Time Based <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('timeBased') is-invalid @enderror" id="message"
                                        name="timeBased" rows="2" placeholder="Time Based">{!! $data->smart_time !!}</textarea>
                                    @error('timeBased')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="ManWSBH">Man WSBH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('manWSBH') is-invalid @enderror" id="message-0" name="manWSBH"
                                        rows="2" placeholder="Man WSBH">{!! $data->man_wsbh !!}</textarea>
                                    @error('manWSBH')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="ManWAH">Man WAH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('manWAH') is-invalid @enderror" id="message-0" name="manWAH"
                                        rows="2" placeholder="Man WAH">{!! $data->man_wah !!}</textarea>
                                    @error('manWAH')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input disabled readonly class="form-check-input justifikasiSwitch" type="checkbox"
                            ...
                            @if ($data->man_root_cause)
                                <div class="col-sm-12 root-cause-container">
                                    <div class="form-group">
                                        ...
                                        <textarea disabled readonly id="rootCause-0" rows="2" placeholder="Man Root Cause" class="form-control"
                                            name="man_root_cause">{!! $data->man_root_cause !!}</textarea>
                                    </div>
                                </div>
                            @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="MachineWSBH">Machine WSBH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('machineWSBH') is-invalid @enderror" id="message-1"
                                        name="machineWSBH" rows="2" placeholder="Insert Your Message">{!! $data->machine_wsbh !!}</textarea>
                                    @error('machineWSBH')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="MachineWAH">Machine WAH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('machineWAH') is-invalid @enderror" id="message-1"
                                        name="machineWAH" rows="2" placeholder="Insert Your Message">{!! $data->machine_wah !!}</textarea>
                                    @error('machineWAH')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            @if ($data->machine_root_cause)
                                <div class="col-sm-12 root-cause-container">
                                    <div class="form-group">
                                        ...
                                        <textarea disabled readonly id="rootCause-1" rows="2" placeholder="Man Root Cause" class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="MethodWSBH">Method WSBH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('methodWSBH') is-invalid @enderror" id="message-1"
                                        name="methodWSBH" rows="2" placeholder="Insert Your Message">{!! $data->method_wsbh !!}</textarea>
                                    @error('methodWSBH')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="MethodWAH">Method WAH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('methodWAH') is-invalid @enderror" id="message-1"
                                        name="methodWAH" rows="2" placeholder="Insert Your Message">{!! $data->method_wah !!}</textarea>
                                    @error('methodWAH')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="MaterialWSBH">Material WSBH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('materialWSBH') is-invalid @enderror" id="message-1"
                                        name="materialWSBH" rows="2" placeholder="Insert Your Message">{!! $data->material_wsbh !!}</textarea>
                                    @error('materialWSBH')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="MaterialWAH">Material WAH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('materialWAH') is-invalid @enderror" id="message-1"
                                        name="materialWAH" rows="2" placeholder="Insert Your Message">{!! $data->material_wah !!}</textarea>
                                    @error('materialWAH')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="EnvironmentWSBH">Environment WSBH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('environmentWSBH') is-invalid @enderror" id="message-1"
                                        name="environmentWSBH" rows="2" placeholder="Insert Your Message">{!! $data->environment_wsbh !!}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label" for="EnvironmentWAH">Environment WAH <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('environmentWAH') is-invalid @enderror" id="message-1"
                                        name="environmentWAH" rows="2" placeholder="Insert Your Message">{!! $data->environment_wah !!}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="What">What <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('what') is-invalid @enderror" id="message-1" name="what"
                                        rows="2" placeholder="Apa rencana penanggulangannya?">{!! $data->what !!}</textarea>
                                    @error('what')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Who">Who <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('who') is-invalid @enderror" id="message-1" name="who"
                                        rows="2" placeholder="Siapa yang melakukannya?">{!! $data->who !!}</textarea>
                                    @error('who')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="why">Why <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('why') is-invalid @enderror" id="message-1" name="why"
                                        rows="2" placeholder="Kenapa harus dilakukan?">{!! $data->why !!}</textarea>
                                    @error('why')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Where">Where <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('where') is-invalid @enderror" id="message-1" name="where"
                                        rows="2" placeholder="Dimana penanggulangan tersebut dilakukan?">{!! $data->where !!}</textarea>
                                    @error('where')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="When">When <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('when') is-invalid @enderror" id="message-1" name="when"
                                        rows="2" placeholder="Kapan penanggulangan tersebut dilakukan?">{!! $data->when !!}</textarea>
                                    @error('when')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="How">How <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('how') is-invalid @enderror" id="message-1" name="how"
                                        rows="2" placeholder="Bagaimana caranya penanggulangan tersebut dilakukan?">{!! $data->how !!}</textarea>
                                    @error('how')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Quality">Quality <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('quality') is-invalid @enderror" id="message-1"
                                        name="quality" rows="2" placeholder="quality">{!! $data->quality !!}</textarea>
                                    @error('quality')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Cost">Cost <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('cost') is-invalid @enderror" id="message-1" name="cost"
                                        rows="2" placeholder="cost">{!! $data->cost !!}</textarea>
                                    @error('cost')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Delivery">Delivery <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('delivery') is-invalid @enderror" id="message-1"
                                        name="delivery" rows="2" placeholder="delivery">{!! $data->delivery !!}</textarea>
                                    @error('delivery')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Safety">Safety <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('safety') is-invalid @enderror" id="message-1" name="safety"
                                        rows="2" placeholder="safety">{!! $data->safety !!}</textarea>
                                    @error('safety')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Morale">Morale <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('morale') is-invalid @enderror" id="message-1" name="morale"
                                        rows="2" placeholder="morale">{!! $data->morale !!}</textarea>
                                    @error('morale')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Productivity">Productivity <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('productivity') is-invalid @enderror" id="message-1"
                                        name="productivity" rows="2" placeholder="productivity">{!! $data->productivity !!}</textarea>
                                    @error('productivity')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="Environment">Environment <small
                                            class="text-danger">*</small></label>
                                    <textarea disabled readonly class="form-control @error('environment') is-invalid @enderror" id="message-1"
                                        name="environment" rows="2" placeholder="environment">{!! $data->environment !!}</textarea>
                                    @error('environment')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label" for="Standarisasi">Standarisasi <small
                                        class="text-danger">*</small></label>
                                <textarea disabled readonly class="form-control @error('standarisasi') is-invalid @enderror" id="message-1"
                                    name="standarisasi" rows="2" placeholder="standarisasi">{!! $data->standarisasi !!}</textarea>
                                @error('standarisasi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label" for="NextStep">Next Step <small
                                        class="text-danger">*</small></label>
                                <textarea disabled readonly class="form-control @error('nextStep') is-invalid @enderror" id="message-1"
                                    name="nextStep" rows="2" placeholder="Next Step">{!! $data->nextStep !!}</textarea>
                                @error('nextStep')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="TotalBiaya">Total Biaya <small
                                            class="text-danger">*</small></label>
                                    <input disabled readonly type="number"
                                        class="form-control @error('totalBiaya') is-invalid @enderror" name="totalBiaya"
                                        placeholder="Total Biaya" value="{{ $data->biaya }}">
                                    @error('totalBiaya')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="costSaving">Total Keuntungan (cost saving) <small
                                            class="text-danger">*</small></label>
                                    <input disabled readonly type="number"
                                        class="form-control @error('costSaving') is-invalid @enderror" name="costSaving"
                                        placeholder="Total Keuntungan (cost saving)" value="{{ $data->costSaving }}">
                                    @error('costSaving')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-sm-12" style="margin-top: 10px;">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input disabled readonly type="file"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Return One Sheet Report</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('v1.mstdSpv.osr.store', $data->id) }}" method="POST"
    ...
    <div id="approvalModalCenter" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Approve One Sheet Report</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('v1.mstdSpv.osr.store', $data->id) }}" method="POST"
