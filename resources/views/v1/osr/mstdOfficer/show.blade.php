        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('v1.mstdOfficer.osr.store', $data->id) }}" method="POST"
                ...
                <div class="modal-body">
                    <form action="{{ route('v1.mstdOfficer.osr.store', $data->id) }}" method="POST"
                        ...
                        <div class="form-group" id="nomorCC">
                            <label class="form-label" for="nomorSS">Nomor OSR</label>
                            <input type="text" class="form-control" readonly name="nomorOSR" value="OSR/2024/1241"
