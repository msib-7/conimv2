        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <h5>New Suggestion System</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('v1.ss.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tema') is-invalid @enderror"
                                        name="tema" placeholder="E.g Tema SS">
                                    @error('tema')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('lokasi') is-invalid @enderror"
                                        name="lokasi" placeholder="E.g lokasi SS">
                                    @error('lokasi')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{ asset('assets/images/no_image.png') }}" class="imgPrev" id="prevSebelum">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('assets/images/no_image.png') }}" class="imgPrev" id="prevSesudah">
                                <div class="form-group">
