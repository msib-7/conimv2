...
@section('button')
    <div class="d-flex">
        <a href="{{ route('v1.ss.create') }}" class="btn btn-primary btn-nav"><i class="ti ti-plus me-1"></i>Add New</a>
    </div>
@endsection
        ...
        $(function() {
            ...
            $('body').on('click', '.deletePost', function() {
                ...
                Swal.fire({
                    ...
                    text: "Menghapus data Suggestion System akan menghapus seluruh informasi Suggestion System",
                    icon: "warning",
