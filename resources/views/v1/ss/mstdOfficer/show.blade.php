                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="tema">Total Biaya <small
                                        class="text-danger">*</small></label>
                                <input type="text" class="form-control @error('biaya') is-invalid @enderror" readonly
                                    name="biaya" placeholder="E.g biaya SS"
                                    value="Rp. {{ number_format($data->biaya) }}">
                                @error('biaya')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="tema">Total Keuntungan (cost saving) <small
                                        class="text-danger">*</small></label>
                                <input type="text" class="form-control @error('cost_saving') is-invalid @enderror"
                                    readonly name="cost_saving" placeholder="E.g cost_saving SS"
                                    value="Rp {{ number_format($data->cost_saving) }}">
                                @error('cost_saving')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('v1.mstdOfficer.suggestionSystem.store', $data->id) }}" method="POST"
                ...
                <div class="modal-body">
                    <form action="{{ route('v1.mstdOfficer.suggestionSystem.store', $data->id) }}" method="POST"
                        ...
                        <div class="form-group" id="nomorCC">
                            <label class="form-label" for="nomorSS">Nomor SS</label>
                            <input type="text" class="form-control" readonly name="nomorSS" value="SS/2024/1241"
