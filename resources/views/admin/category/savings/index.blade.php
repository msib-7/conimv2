...
@section('content')
                    ...
                    <form method="POST" id="productForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" id="title"
                                placeholder="E.g Saving Machine">
                        </div>
                        <div class="form-group">
    ...
    <div id="importModalCenter" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="importModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importModalCenterTitle">Import Excell</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.category.improvment.importExcel') }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#footer-select').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.category.improvment.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $('body').on('click', '.editPost', function() {
                ...
                $.get(url, function(data) {
                    ...
                    $('#exampleModalCenterTitle').html("Edit Data Category Saving");
            ...
            $('#createNewPost').click(function() {
                ...
                $('#exampleModalCenterTitle').html("Add New Category Saving");
            ...
            $('#savedata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.category.costSaving.store') }}",
                    type: "POST",
                    dataType: 'json',
