    ...
    <div id="importModalCenter" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="importModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.category.costSaving.importExcel') }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#footer-select').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.category.costSaving.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $('body').on('click', '.editPost', function() {
                ...
                $.get(url, function(data) {
                    ...
                    $('#exampleModalCenterTitle').html("Edit Data Category");
            ...
            $('#createNewPost').click(function() {
                ...
                $('#exampleModalCenterTitle').html("Add New Category");
