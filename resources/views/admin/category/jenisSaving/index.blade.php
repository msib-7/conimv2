        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h5>@yield('title')</h5>
                    <p>
                        Manage Your Category jenis Savings
                    </p>
                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#footer-select').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.category.jenisSaving.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $('body').on('click', '.editPost', function() {
                ...
                $.get(url, function(data) {
                    ...
                    $('#exampleModalCenterTitle').html("Edit Data Category Jenis Saving");
            ...
            $('#createNewPost').click(function() {
                ...
                $('#exampleModalCenterTitle').html("Add New Category Jenis Saving");
            ...
            $('#savedata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.category.jenisSaving.store') }}",
                    type: "POST",
                    dataType: 'json',
