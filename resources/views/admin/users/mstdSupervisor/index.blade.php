        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5>Managament Account MSTD SPV</h5>
                    <small>Create Or Update Or Delete User in MSTD SPV</small>
                </div>
                <div class="card-body">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#footer-select').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.users.mstdSpv.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $('#select2').select2({
                ...
                ajax: {
                    url: "{{ route('admin.users.mstdSpv.getHrisEmployee') }}",
                    dataType: 'json',
                    delay: 150,
                    processResults: data => {
                        return {
            ...
            $('#savedata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.users.mstdSpv.store') }}",
                    type: "POST",
                    dataType: 'json',
